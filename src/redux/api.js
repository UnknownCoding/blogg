...
export const getTour = (page) => API.get(`/tour?page=${page}`);
export const getSingleTour = (id) => API.get(`/tour/${id}`);
export const getUserTour = (Userid) => API.get(`/tour/userTours/${Userid}`);
...
export const getTagByTours = (tag) =>API.get(`/tour/tag/${tag}`);
